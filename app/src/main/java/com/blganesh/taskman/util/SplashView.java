...
import com.blganesh.taskman.BuildConfig;
...
public class SplashView extends View {
    ...
    private void setupAttributes(AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CustomSplashView);

        int numAttrs = a.getIndexCount();
        for (int i = 0; i < numAttrs; ++i) {
            int attr = a.getIndex(i);
            switch (attr) {
                case R.styleable.CustomSplashView_splashIcon:
                    setIconDrawable(a.getDrawable(i));
                    break;
                case R.styleable.CustomSplashView_iconColor:
                    setIconColor(a.getColor(i, DEFAULT_ICON_COLOR));
                    break;
                case R.styleable.CustomSplashView_holeFillColor:
                    setHoleFillColor(a.getColor(i, DEFAULT_HOLE_FILL_COLOR));
                    break;
                case R.styleable.CustomSplashView_duration:
                    setDuration(a.getInt(i, DEFAULT_DURATION));
                    break;
                case R.styleable.CustomSplashView_removeFromParentOnEnd:
